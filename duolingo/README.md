# Notarize Duolingo Streak

These two files `.rs` + `.env` are meant to be copied inside a new folder inside the TLSN examples.
Also, in the `Cargo.toml` this has to be added:
```
[[example]]
