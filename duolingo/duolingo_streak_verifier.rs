...
/// A simple verifier which reads a proof generated by `duolingo.rs` from "duolingo_proof.json", verifies
/// it and prints the verified data to the console.
fn main() {
    // Deserialize the proof
    let proof = std::fs::read_to_string("duolingo_proof.json").unwrap();
